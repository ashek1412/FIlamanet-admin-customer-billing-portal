...
>
    ...
    <body
        {{ $attributes
                ...
                ->class([
                    ...
                    'min-h-screen max-w-full bg-gray-50 font-normal text-gray-950 antialiased dark:bg-gray-800 dark:text-white m-2',
                ]) }}
    >
    ...
    <footer class="bg-white rounded-lg shadow-sm m-2 dark:bg-gray-800">
